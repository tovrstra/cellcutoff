...
#DEBUG        
#        message( "pxd: " ${pxd} )
#        foreach( md ${module_dependencies} )
#           message( ${md} )
#        endforeach()
#END DEBUG
  ...
  foreach( _include_dir ${cython_include_directories} )
    message( "Include dir:" ${_include_dir} ) # DEBUG
...
function( cython_add_module _name )
  ...
  message( "Using Numpy at ${PYTHON_NUMPY_INCLUDE_DIR}" ) #DEBUG
  include_directories( ${PYTHON_NUMPY_INCLUDE_DIR} )
#  message( "PYTHON_INCLUDE_DIRS:  ${PYTHON_INCLUDE_DIRS} ${PYTHON_LIBRARY}" ) # DEBUG
  python_add_module( ${_name} ${generated_file} ${other_module_sources} )
  if( APPLE )
    set_target_properties( ${_name} PROPERTIES LINK_FLAGS "-undefined dynamic_lookup" )
  else()
    message( "Linking ${_name} ${CYTHON_LINK}" )
    target_link_libraries( ${_name} ${CYTHON_LINK} )
  endif()
endfunction()
